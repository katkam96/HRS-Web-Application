<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/HomePage.Master" CodeBehind="UpdateProject.aspx.cs" Inherits="MYWEBAPPLICATION3.UpdateProject" %>

<asp:Content ID="UpdateProjectContent" runat="server" ContentPlaceHolderID="HomePageCPH">
    <div>
        <table>
            ...
            <tr>
                <td>
                    <asp:Button ID="btnUpdateProject" runat="server" Text="Update Project" OnClick="btnUpdateProject_Click" />
                </td>
                <td>
